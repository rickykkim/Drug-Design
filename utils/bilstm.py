...
class BILSTM_trainer:
    ...
    References:
        ...
        2. https://medium.com/data-science-data-engineering/time-series-prediction-lstm-bi-lstm-gru-99334fc16d75
    """
    ...
    # Initialize model with pure LSTM
    def init_model(self):
        """
    ...
    def train_epoch(self, epoch):
        ...
        for i in range(num_batches):
            ...
            # Print progress every 10 batches and at the end
    ...
    def run(self):
        ...
        for epoch in range(self.epochs):
            ...
            if val_mae < best_val_mae:
                ...
                self.model.save_weights('model/best_bilstm_model_weights.h5')
                print("Updated the best BiLSTM model")
            else:
                patience_counter += 1
                ...
                if patience_counter >= 5:
                    ...
                    self.model.load_weights('model/best_bilstm_model_weights.h5')
                    break
